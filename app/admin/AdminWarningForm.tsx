...
export function AdminWarningForm({ memberId }: Props) {
  ...
  return (
    <form action={submitWarning} className="rounded-3xl border border-yellow-400/20 bg-yellow-400/10 p-6">
      <p className="text-xs font-black tracking-[5px] text-yellow-300">WARNING CENTER</p>
      <h2 className="mt-2 text-3xl font-black text-white">إصدار تحذير</h2>
      ...
      <button
        disabled={loading}
        className="mt-5 rounded-2xl bg-yellow-400 px-7 py-3 font-black text-black transition hover:bg-yellow-300 disabled:opacity-50"
      >
